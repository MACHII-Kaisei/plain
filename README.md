...
タスク一覧はサイドバーで「今週 / これから / 完了済み」を切り替え。デスクトップ・通知センターのウィジェットからはタスクの確認と完了操作ができる。

| メイン画面 | ウィジェット |
| --- | --- |
| <img src="docs/images/main-thisweek.png" alt="メイン画面（今週タブ）" width="640"> | <img src="docs/images/widget.png" alt="TODO ウィジェット" width="300"> |

### タスク編集

メモ・参照 URL・タグ・期日をひとつの画面で編集。日付はインライン展開する大きなカレンダー、時刻は 15 分刻みのリストからワンクリックで選択できる。

| エディタ | カレンダー | 時刻選択 |
| --- | --- | --- |
| <img src="docs/images/editor.png" alt="タスクエディタ"> | <img src="docs/images/editor-calendar.png" alt="インラインカレンダー"> | <img src="docs/images/editor-timepicker.png" alt="時刻リストピッカー"> |
